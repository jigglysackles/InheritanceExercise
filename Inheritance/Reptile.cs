...
public class Reptile : Animal
{
    ...
    private static readonly int _descriptorRandom = randomNum.Next(1, 4);
    ...
    public static void DisplayReptileInfo(Reptile reptile)
    {
        ...
        Console.WriteLine(
            $"This particular {reptile.Name} has {reptile.ScaleSizeSML} scales in relation to other reptiles.");

        if (reptile.HeartChambers == 3)
            Console.WriteLine($"Like most reptiles, the {reptile.Name} has {reptile.HeartChambers} heart chambers.");
        else
            Console.WriteLine(
                $"Unlike other reptiles which usually have three heart chambers, the {reptile.Name} has {reptile.HeartChambers} heart chambers.");
        ...
        switch (reptile.Legs)
        {
            case 0:
                Console.WriteLine(
                    "This is a slippy snake since it has no legs. If it should have had legs...it's now an honorary snake.");
                return;
            case 1:
                Console.WriteLine(
                    "That little guy? I wouldn't worry about that little guy. Weird that he's there though...just...dangling...");
                return;
            case 2:
            ...
            case 4:
                Console.WriteLine(
                    "This reptile has four legs. Four on the floor was the manual gearbox arrangement for my second car.");
                return;
        }
    }
}